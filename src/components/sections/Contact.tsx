    ...
    <Section id="contato" style={{ background: "#FFFFFF" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div className="reveal" style={{ textAlign: "center", marginBottom: "4rem" }}>
          <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500, letterSpacing: "-0.04em", fontSize: "clamp(2.5rem, 4vw, 3.8rem)", color: "#2B1C1D" }}>
            Vamos conversar?
          </h2>
          <p style={{ color: "#5A6778", fontSize: "1.1rem", fontWeight: 400, maxWidth: 500, margin: "1rem auto 0" }}>
            Preencha o formulário abaixo e nossa equipe de triagem entrará em contato rapidamente para agendar seu horário.
          </p>
        </div>

        <div className="reveal" style={{
          display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", background: "#FFFFFF",
          borderRadius: 16, overflow: "hidden", boxShadow: "0 10px 40px rgba(92,49,54,.06)", border: "1px solid rgba(92,49,54,.05)"
        }}>
          
          <div style={{ background: "#5C3136", color: "#FFFFFF", padding: "4rem 3rem", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
            ...
            >
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
                <div>
                  ...
                  <input type="text" placeholder="Ex: Maria Oliveira" value={form.nome} onChange={(e) => setForm({ ...form, nome: e.target.value })} required className="field" style={{ background: "#FDFBF9", border: "none", borderBottom: "1px solid rgba(92,49,54,.1)", borderRadius: "6px 6px 0 0", padding: "1rem" }} />
                </div>
                <div>
                  ...
                  <input type="tel" placeholder="(11) 9 0000-0000" value={form.telefone} onChange={(e) => setForm({ ...form, telefone: e.target.value })} required className="field" style={{ background: "#FDFBF9", border: "none", borderBottom: "1px solid rgba(92,49,54,.1)", borderRadius: "6px 6px 0 0", padding: "1rem" }} />
                </div>
              </div>
              ...
              <div>
                ...
                <select value={form.servico} onChange={(e) => setForm({ ...form, servico: e.target.value })} className="field" style={{ background: "#FDFBF9", border: "none", borderBottom: "1px solid rgba(92,49,54,.1)", borderRadius: "6px 6px 0 0", padding: "1rem" }}>
              ...
              <div>
                ...
                <textarea rows={4} placeholder="Descreva brevemente o motivo do agendamento..." value={form.mensagem} onChange={(e) => setForm({ ...form, mensagem: e.target.value })} className="field" style={{ resize: "none", background: "#FDFBF9", border: "none", borderBottom: "1px solid rgba(92,49,54,.1)", borderRadius: "6px 6px 0 0", padding: "1rem" }} />
              </div>

              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "1rem", flexWrap: "wrap", gap: "1.5rem" }}>
                <button type="submit" className="btn-primary" style={{ padding: "1rem 2.5rem" }}>Solicitar Agendamento</button>
                <a href="https://wa.me/5511999999999" target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 8, color: "#5C3136", textDecoration: "none", fontWeight: 500, fontSize: "0.9rem", transition: "opacity 0.2s" }} onMouseEnter={(e) => e.currentTarget.style.opacity = "0.7"} onMouseLeave={(e) => e.currentTarget.style.opacity = "1"}>
