      ...
      <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 relative">
        ...
        <div className="lg:w-5/12 lg:sticky lg:top-32 lg:h-max">
          ...
          <p className="reveal mt-6" style={{ color: "#5A6778", fontSize: "1.05rem", lineHeight: 1.8, fontWeight: 300 }}>
            Nossa clínica oferece uma <strong className="font-medium text-[#5C3136]">abordagem integrada</strong>, combinando <strong className="font-medium text-[#5C3136]">tecnologia de ponta</strong> com a precisão artesanal que cada tratamento exige. Da avaliação inicial ao acompanhamento contínuo.
          </p>
