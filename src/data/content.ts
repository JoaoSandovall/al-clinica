...
export const faqs = [
  ...
  { q: "Vocês atendem convênios?", a: "Trabalhamos com os principais convênios e também oferecemos parcelamento próprio em até sem juros para tratamentos fora do plano." },
];
